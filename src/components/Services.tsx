...
const services = [
  ...
  { title: "Baby Shower Flower Decoration", image: "/services/baby3.jpg", slug: "baby-shower-flower-decoration" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Link key={index} to={`/services/${service.slug}`}>
              <Card className="rounded-xl overflow-hidden shadow-lg hover:scale-105 transition-transform cursor-pointer">
               <img
  src={service.image}
  alt={service.title}
...
/>
                ...
                <CardContent className="py-4 text-center bg-white">
