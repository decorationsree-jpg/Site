    ...
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 sm:gap-12 items-start">
          {/* Contact Info */}
          <div className="lg:col-span-1 space-y-6 sm:space-y-8 backdrop-blur-sm bg-black/20 p-6 sm:p-8 rounded-lg border border-[#D4AF37]/20 shadow-xl">
            <h3 className="text-xl sm:text-2xl font-bold text-[#E2C39A] mb-4">
              Get in Touch
            </h3>
            ...
            <div className="flex items-start gap-3 group">
              ...
              <div>
                <h4 className="font-semibold text-[#E2C39A] text-base sm:text-lg mb-1">
                  Phone
                </h4>
                <p className="space-y-1 text-sm sm:text-base">
                  <a
                    href="tel:+919666204467"
                    className="block hover:text-[#D4AF37] transition-colors"
                  >
                    +91 96662 04467
                  </a>
                  <a
                    href="tel:+919700450027"
                    className="block hover:text-[#D4AF37] transition-colors"
                  >
                    +91 97004 50027
                  </a>
            ...
            <div className="flex items-start gap-3 group">
              ...
              <div>
                ...
                <a
                  href="mailto:sireeeventshyd@gmail.com"
          ...
          <Card className="lg:col-span-2 border-[#D4AF37]/20 shadow-2xl backdrop-blur-sm bg-black/20">
            <CardContent className="p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-[#E2C39A] mb-4 sm:mb-6">
                Send us a Message
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <Input
                  ...
                  className="bg-white/5 border-[#D4AF37]/20 text-white rounded-lg focus:border-[#D4AF37] text-sm sm:text-lg"
                  value={formData.name}
                ...
                <div className="relative md:col-span-2">
                  <select
                    name="eventType"
                    className="w-full appearance-none bg-white/5 border border-[#D4AF37]/20 text-white rounded-lg text-sm sm:text-lg p-2 sm:p-3 pr-10 focus:border-[#D4AF37] cursor-pointer [&_option]:bg-white [&_option]:text-black"
                    value={formData.eventType}
                    onChange={handleInputChange}
                  >
                    <option value="">Select Event Type</option>
                    <option value="Wedding Decoration">Wedding Decoration</option>
                    <option value="Birthday Balloon Decoration">
                      Birthday Balloon Decoration
                    </option>
                    <option value="Haldi Function Decoration">
                      Haldi Function Decoration
                    </option>
                ...
                <Textarea
                  ...
                  className="bg-white/5 border-[#D4AF37]/20 text-white min-h-[120px] sm:min-h-[150px] rounded-lg focus:border-[#D4AF37] text-sm sm:text-lg md:col-span-2"
